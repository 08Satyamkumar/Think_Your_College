...
export default function ContactPage() {
    ...
    try {
      await fetch("/api/leads", {
        ...
        body: JSON.stringify({
          ...
          college_interest: `Contact Form - Marks: ${formData.marks || "N/A"} | Msg: ${formData.msg || "N/A"}`,
          status: "Pending",
        }),
      });
    } catch (err) {
      console.error("Failed to send contact lead to Supabase:", err);
    }
  ...
  const offices = [
    {
      ...
      address:
        "Boring Road Crossing, Near Bank of Baroda, Patna, Bihar - 800001",
      phone: "+91 9135800500",
    },
    {
      city: "Delhi-NCR Branch Office",
      address:
        "Alpha 1, Greater Noida, Near Metro Station, Uttar Pradesh - 201308",
      phone: "+91 9473332444",
    },
  ];
  ...
  return (
    <div className="space-y-8">
      {/* HEADER */}
      <div>
        <h1 className="font-outfit font-extrabold text-3xl text-text_primary">
          Admissions Counseling Helpdesk
        </h1>
        <p className="text-sm text-text_secondary">
          Get in touch with certified advisors for direct seat allotment &
          credit card scholarship support
        </p>
      </div>
        ...
        <div className="lg:col-span-6 bg-card border border-border p-6 md:p-8 rounded-3xl shadow-sm space-y-6">
          <div className="space-y-2">
            <h2 className="font-outfit font-bold text-lg text-text_primary">
              Submit Counseling Query
            </h2>
            <p className="text-xs text-text_secondary leading-relaxed font-medium">
              Provide your academics details and entrance scores. Our senior
              counselor will evaluate your profile and prepare a list of best
              possible colleges.
            </p>
          </div>
          ...
          {formSubmitted ? (
            <div className="py-16 text-center space-y-4">
              ...
              <p className="text-sm text-text_secondary max-w-sm mx-auto leading-relaxed">
                Thank you for reaching out. A counselor specializing in **
                {formData.course}** has been assigned and will call you on **+91{" "}
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4 pt-2">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="text-[10px] text-text_secondary font-bold uppercase tracking-wider">
                    Your Full Name
                  </label>
                  <input
                    required
          ...
          <div className="bg-card border border-border p-6 rounded-3xl shadow-sm space-y-4">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  <p className="text-[9px] text-text_secondary font-bold uppercase">
                    Main Support Number
                  </p>
                  <p className="font-outfit font-extrabold text-sm text-text_primary">
                    +91 9135800500
                  </p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-outfit font-extrabold text-sm text-emerald-600 dark:text-emerald-400">
